...
export default function Favorites() {
  ...
  if (!user) return <div className="favorites-wrapper"><h3>Please sign in...</h3></div>;

  if (loading) return <div className="favorites-wrapper"><h3>Loading...</h3></div>;

  if (!loading && favoriteQuizzes.length === 0) {
    return (
      <div className="favorites-wrapper">
        <h3 className="no-favorites">You have no favorites yet.</h3>
      </div>
    );
  }
